  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-800/50 p-8 rounded-2xl">
            <p className="text-lg text-gray-300 leading-relaxed">
              Sou um desenvolvedor de sistemas apaixonado por criar experiências
              digitais excepcionais. Com mais de 4 anos de experiência em
              desenvolvimento web, combino habilidades técnicas com um olhar
              aguçado para design, entregando soluções que não só funcionam
              perfeitamente, mas também impressionam visualmente.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="py-6 text-center text-gray-400 border-t border-gray-800">
        <p>© 2024 Thomas Silva. Todos os direitos reservados.</p>
      </footer>
    </div>
  );
}
